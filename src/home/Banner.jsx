...
const title = <h2>Search Your One From <span>Thousand</span> of our Products</h2>;
...
// search setup
    const handleSearch = e => {
        ...
        const filtered = productData.filter((product) => product.name.toLowerCase().includes(searhTerm.
        toLowerCase()));
